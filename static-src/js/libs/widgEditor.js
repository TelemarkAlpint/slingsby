...
**    * Removed the editor css, as it didn't do anything (as I could see). Orignal value: "css/widgContent.css"
**
**
**    Function list:
**    -------------------------------------------------------------------------
...
widgSelectBlockOptions.push("<h4>", "Heading 1");
widgSelectBlockOptions.push("<h5>", "Heading 2");
