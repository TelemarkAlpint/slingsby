        ...
        if (partialsPathRegex.test(filepath) && isPartial.test(_.last(filepath.split('/')))) {
          ...
          if (options.namespace !== false) {
            ...
            if (options.closure){
              ...
              templates.push("  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};");
              templates.push("templates['" + processPartialName(filepath) + "'] = template(" + compiled + ");\n})();");
            } else {
